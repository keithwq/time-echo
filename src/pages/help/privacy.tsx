...
const privacySections: PrivacySection[] = [
  ...
  },
  {
    ...
    title: '水滴规则说明',
    content: [
      '每个新用户获得 50 个水滴：40 个基础冻结，10 个可操作。',
      '基础冻结的 40 个水滴用于购买一轮基础访谈资格，不可提前使用或退回。',
      '可操作的 10 个水滴可用于：增加问题（1 滴 = 2 题）、第二次及以后的 AI 润色（5 滴/次）。',
      '首次 AI 润色免费，第二次及以后每次消耗 5 个水滴。',
      '通过邀请朋友可获得额外水滴：每邀请 1 人，双方各获 5 滴。',
      '邀请获得的额外水滴在获得后 180 天过期，基础水滴不过期。',
      '所有水滴操作都会被记录在"水滴账户"中，您可随时查看。',
    ],
  },
  {
    id: 'user-agreement',
