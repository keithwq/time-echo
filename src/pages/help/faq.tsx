...
const faqData: FAQ[] = [
  {
    ...
    question: '什么是墨水？',
    answer:
      '墨水是时光回响的虚拟货币，用于购买访谈资格和扩展功能。每个新用户会获得 50 个墨水。其中 40 个用于购买一轮基础访谈资格，剩余 10 个可用于扩展操作（如增加问题、AI 润色等）。',
  },
  {
    id: 'faq-002',
    question: '我有 40 个墨水，为什么不能直接用？',
    answer:
      '40 个墨水是"基础冻结"，用于购买一轮基础访谈资格。这部分墨水无法提前使用或退回。另外有 10 个"可操作"墨水，才能用于扩展操作。这样设计是为了保护用户的基础权益。',
  },
  {
    id: 'faq-003',
  ...
  },
  {
    ...
    question: '如何获得更多墨水？',
    answer:
      '主要方式是邀请朋友使用时光回响。每成功邀请 1 人，双方各获得 5 个额外墨水。被邀请人使用邀请链接注册后，邀请会立即生效。',
  },
  {
    id: 'faq-005',
    question: '邀请朋友有什么奖励？',
    answer:
      '每成功邀请 1 个朋友，您会获得 5 个额外墨水。被邀请人也会获得 5 个额外墨水作为新用户奖励。这些墨水可用于扩展操作。',
  },
  {
    id: 'faq-006',
    question: '墨水会过期吗？',
    answer:
      '基础冻结的 40 个墨水与账户绑定，不会过期。额外获得的墨水（如邀请奖励）会在获得后 180 天过期。建议及时使用。',
  },
  {
    id: 'faq-007',
