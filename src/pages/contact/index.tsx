  ...
  return (
    <div className="min-h-dvh bg-paper-base">
      <header className="px-6 py-4 border-b border-ink-wash sticky top-0 bg-paper-base z-10">
        ...
        <h1 className="text-2xl font-serif text-ink-heavy tracking-widest">联系我们</h1>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="mb-6 p-6 bg-paper-deep border-2 border-ink-wash rounded-sm hover:border-seal-red transition-colors">
          <h3 className="text-2xl font-serif text-ink-heavy mb-4">📱 微信客服</h3>
          ...
          <div className="bg-paper-base p-4 rounded-sm mb-4 text-center">
            <p className="text-base text-ink-wash">[微信二维码]</p>
            <p className="text-lg text-ink-heavy mt-2 font-bold">扫码添加客服</p>
          </div>
          <p className="text-base text-ink-wash">客服工作时间：9:00 - 18:00（工作日）</p>
        </div>

        {/* 邮件反馈 */}
        <div className="mb-6 p-6 bg-paper-deep border-2 border-ink-wash rounded-sm hover:border-seal-red transition-colors">
          <h3 className="text-2xl font-serif text-ink-heavy mb-4">📧 邮件反馈</h3>
          <p className="text-lg text-ink-medium mb-4">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <button
              ...
              className="px-3 py-2 min-h-[40px] text-base bg-seal-red text-paper-base rounded-sm hover:bg-opacity-90 transition-colors"
            >
              复制
            </button>
          </div>
          <p className="text-base text-ink-wash">我们会在 24 小时内回复您的邮件</p>
        </div>

        {/* 在线反馈 */}
        <div className="mb-6 p-6 bg-paper-deep border-2 border-ink-wash rounded-sm hover:border-seal-red transition-colors">
          <h3 className="text-2xl font-serif text-ink-heavy mb-4">✏️ 在线反馈</h3>
          <p className="text-lg text-ink-medium mb-6">
            如果您有任何建议或发现问题，可以通过在线表单告诉我们。
          </p>
          <button
            onClick={() => router.push('/contact/feedback')}
            className="w-full px-6 py-3 min-h-[56px] bg-seal-red text-paper-base text-lg font-serif rounded-sm hover:bg-opacity-90 transition-colors"
          >
            提交反馈
          </button>
        </div>
        ...
        <div className="mt-12 p-6 bg-paper-deep border border-ink-wash rounded-sm">
          <h3 className="text-xl font-serif text-ink-heavy mb-4">或者查看</h3>
          <div className="flex flex-col gap-3">
            <button
              onClick={() => router.push('/help/faq')}
              className="w-full text-left px-4 py-3 min-h-[48px] bg-paper-base border-2 border-ink-wash rounded-sm hover:border-seal-red transition-colors text-lg text-ink-heavy font-serif"
            >
              ❓ 常见问题
            </button>
            <button
